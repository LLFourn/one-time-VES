...
We use this intuition to prove that any \EUFCMAVES scheme is also unforgeable. First we recall the original BGLS definition.
...
If a VES scheme is \EUFCMAVES secure and has the \emph{validity} property then it also has the original BGLS unforgeability property defined above.
\end{theorem}
